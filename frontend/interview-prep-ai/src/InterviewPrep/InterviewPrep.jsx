...
import SkeletonLoader from '../Components/Loader/SkeletenLoader'
...
const InterviewPrep = () => {
  ...
  const generateConceptExplanation = async (question) => {
    try {
      ...
      setExplanation(null);
      setErrorMsg("Failed to generate an explanation. Try again later.")
      console.error("Error", error);
    } finally {
      setIsLoading(false);
    }
      ...
      <div className='container mx-auto px-4 pb-4 pt-4 md:px-0'>
        ...
        <div>
          <Drawer
            ...
            isClose={() => setOpenLearnMoreDrawer(false)}
